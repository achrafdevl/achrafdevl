...
<p align="center">
  ...
  [![My Skills](https://skillicons.dev/icons?i=github,git,html,css,js,ts,react,redux,nextjs,tailwind,bootstrap,nodejs,express,figma,mongodb,postman,docker,flutter,npm,vite,vercel,wordpress,materialui,vue,vuetify,vscode,stackoverflow,mysql,jest,redux-saga,graphql,vuex,adobexd,sketch,axure,&perline=12)](https://skillicons.dev)
</p>
